...
select name, description, price, category, image, veg, popular, chef, seasonal, rating, created_at from (values
  ('Ember Espresso', 'A double shot of our house single-origin, pulled thick and rich with a golden crema.', 380, 'Signature Coffee', '/images/coffee-1.svg', true, true, false, false, 5, now() - (50) * interval '1 second'),
  ('Ivy Flat White', 'Velvety micro-foam over a ristretto base. The quiet favourite of regulars.', 420, 'Signature Coffee', '/images/coffee-2.svg', true, false, false, false, 5, now() - (49) * interval '1 second'),
  ('Himalayan Latte', 'Silky steamed milk, house espresso and a whisper of local cardamom honey.', 460, 'Signature Coffee', '/images/coffee-3.svg', true, true, false, true, 4, now() - (48) * interval '1 second'),
  ...
  ('Turmeric Golden Latte', 'Warm turmeric, ginger, coconut and honey. Comfort in a cup.', 480, 'Signature Coffee', '/images/coffee-3.svg', true, false, false, false, 4, now() - (44) * interval '1 second'),
  ...
  ('Ember English Breakfast', 'Two eggs any way, toast, hash brown, beans and grilled tomato.', 780, 'Breakfast & Brunch', '/images/food-5.svg', false, false, false, false, 5, now() - (41) * interval '1 second'),
  ...
  ('Continental Platter', 'Pastry, fruit, yogurt, honey and an artisan coffee of your choice.', 950, 'Breakfast & Brunch', '/images/food-3.svg', false, false, false, false, 4, now() - (38) * interval '1 second'),
  ...
  ('Arancini Di Riso', 'Crisp risotto balls, saffron, mozzarella, arrabbiata dip.', 720, 'Starters & Small Plates', '/images/food-2.svg', true, false, false, false, 5, now() - (35) * interval '1 second'),
  ...
  ('Loaded Nachos', 'Corn chips, house salsa, cheese sauce, jalapeños and guacamole.', 680, 'Starters & Small Plates', '/images/food-5.svg', true, false, false, false, 4, now() - (33) * interval '1 second'),
  ('Ember Signature Steak', 'Grass-fed New York strip, rosemary butter, roasted garlic, jus.', 1650, 'Chef’s Specials', '/images/food-1.svg', false, true, true, false, 4, now() - (32) * interval '1 second'),
  ...
  ('Lakeside Fish of the Day', 'Catch of the day, lemon butter, caper salsa, charred greens.', 1550, 'Chef’s Specials', '/images/food-7.svg', false, false, true, false, 4, now() - (29) * interval '1 second'),
  ...
  ('Truffle Carbonara', 'Silky egg and pecorino, guanciale, cracked black pepper, truffle.', 850, 'Pasta & Risotto', '/images/food-2.svg', true, true, false, false, 4, now() - (26) * interval '1 second'),
  ...
  ('Seafood Linguine', 'Prawns, mussels, garlic, white wine, chilli, parsley.', 980, 'Pasta & Risotto', '/images/food-7.svg', true, false, false, false, 5, now() - (24) * interval '1 second'),
  ...
  ('Club Sandwich', 'Triple-decker chicken, bacon, egg, lettuce and fries.', 620, 'Burgers & Sandwiches', '/images/food-1.svg', true, false, false, false, 5, now() - (19) * interval '1 second'),
  ('Pokhara Sunset', 'Mango, passionfruit, orange and a sparkling top.', 420, 'Mocktails', '/images/cocktail-5.svg', true, false, false, true, 5, now() - (18) * interval '1 second'),
  ('Ember Fizz', 'Ginger, lime, rosemary and bitters — dry and bright.', 450, 'Mocktails', '/images/cocktail-4.svg', true, false, false, false, 4, now() - (17) * interval '1 second'),
  ('Ivy Blossom', 'Lychee, rose, lemon and soda over crushed ice.', 440, 'Mocktails', '/images/cocktail-3.svg', true, false, false, false, 5, now() - (16) * interval '1 second'),
  ('Lakeside Cooler', 'Blueberry, mint, apple and a citrus twist.', 430, 'Mocktails', '/images/cocktail-5.svg', true, false, false, true, 5, now() - (15) * interval '1 second'),
  ...
  ('Argentine Malbec', 'Dark fruit, plum, velvet finish.', 2400, 'Wine & Beer', '/images/cocktail-4.svg', true, false, false, false, 5, now() - (7) * interval '1 second'),
  ...
  ('Tiramisu Classico', 'Espresso-soaked ladyfingers, mascarpone, cocoa.', 560, 'Desserts', '/images/dessert-3.svg', true, false, false, false, 4, now() - (3) * interval '1 second'),
